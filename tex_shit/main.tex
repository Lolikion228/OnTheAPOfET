...
\noindent где $\Phi(t)$ -- функция стандартного нормального распределения, 
 $z_{1- \frac{\alpha}{2}}$ -- его $1- \frac{\alpha}{2}$ квантиль. А константы $a$,$b$ вычисляются, как было определено в~\cite{melas2024}.
...
\begin{enumerate}
	\item Генерируем выборку $X = (X_1, \ldots, X_{k})$, из $F_1$, где $k = 2n$.
	\item Берём $M$ различных перестановок $\sigma_{i} \in S_k$, $i \in \overline{1,\ldots, M}$
	\item Вычисляем $T( (X_{\sigma_i(1)}, \ldots, X_{\sigma_i(n)}) , (X_{\sigma_i(n+1)}, \ldots, X_{\sigma_i(k)})  )$ для всех $i \in \overline{1,\ldots, M}$
...
\end{equation*}
В таблицах \ref{tbl:ap_normal_h2_diff} и \ref{tbl:ap_normal_h1_diff} представлены значения асимптотической мощности, вычисленные по формуле \eqref{eq:AP},
и эмпирические мощности, полученные для $n = 100$, $400$, $900$, $1600$, $2000$, $3000$.
Для вычисления значений в таблице \ref{tbl:ap_normal_h2_diff} было взято значение $h_1=0$, для вычисления значений в таблице \ref{tbl:ap_normal_h1_diff} было взято значение $h_2=0$.
\end{example}
...
\begin{example}
	...
	\end{equation*}
	В таблицах \ref{tbl:ap_cauchy_h2_diff} и \ref{tbl:ap_cauchy_h1_diff} представлены значения асимптотической мощности, вычисленные по формуле~\eqref{eq:AP},
	и эмпирические мощности, полученные для выборок размера $n = 100$, $400$, $900$, $1600$, $2000$, $3000$. Для вычисления значений в таблице~\ref{tbl:ap_cauchy_h2_diff} было взято значение $h_1=0$, для вычисления значений в таблице~\ref{tbl:ap_cauchy_h1_diff} было взято значение $h_2=2$.
\end{example}
...
\begin{table}[!h]
	...
	\begin{tabular}{l c c c c c c c c c c} 
		...
		& n=100 & 0.05 & 0.08 & 0.1 & 0.14 & 0.19 & 0.26 & 0.32 & 0.42 & 0.51 \\ 
		& n=400 & \textbf{0.07} & 0.1 & \textbf{0.14} & 0.2 & \textbf{0.29} & \textbf{0.41} & 0.53 & 0.63 & 0.75 \\ 
		& n=900 & 0.06 & \textbf{0.09} & 0.13 & \textbf{0.19} & \textbf{0.29} & \textbf{0.41} & \textbf{0.55} & \textbf{0.65} & \textbf{0.78} \\ 
		\addlinespace
		\addlinespace
		\multirow{3}{*}{$\text{ET}_2$} 
		& n=100 & 0.05 & 0.06 & 0.07 & 0.09 & 0.12 & 0.16 & 0.21 & 0.3 & 0.37 \\ 
		& n=400 & 0.06 & 0.07 & 0.1 & 0.14 & 0.2 & 0.28 & 0.38 & 0.49 & 0.61 \\ 
		& n=900 & \textbf{0.07} & 0.08 & 0.12 & 0.18 & 0.25 & 0.36 & 0.48 & 0.61 & 0.74 \\ 
		\bottomrule
	\end{tabular}
...
\begin{table}[!h]
	...
	\begin{tabular}{l c c c c c c c c c c} 
		...
		\midrule
		\multirow{3}{*}{$\text{ET}_1$} 
		& n=100 & \textbf{0.13} & 0.2 & \textbf{0.31} & \textbf{0.43} & \textbf{0.59} & \textbf{0.69} & \textbf{0.8} & \textbf{0.89} & \textbf{0.94} \\ 
		& n=400 & 0.11 & \textbf{0.18} & 0.27 & 0.4 & 0.52 & 0.68 & 0.78 & 0.85 & 0.92 \\ 
		& n=900 & 0.1 & 0.17 & 0.26 & 0.4 & 0.51 & 0.65 & 0.77 & 0.85 & 0.92 \\ 
		\addlinespace
		\addlinespace
		\multirow{3}{*}{$\text{ET}_2$} 
		& n=100 & 0.1 & 0.17 & 0.27 & 0.4 & 0.54 & 0.66 & 0.79 & 0.86 & 0.93 \\ 
		& n=400 & 0.11 & \textbf{0.18} & 0.28 & 0.38 & 0.55 & 0.67 & 0.79 & 0.88 & 0.93 \\ 
		& n=900 & 0.1 & 0.17 & 0.27 & 0.39 & 0.53 & 0.66 & 0.78 & 0.86 & 0.93 \\ 
		\bottomrule
	\end{tabular}
...
\begin{table}[!h]
	...
	\begin{tabular}{l c c c c c c c c c c} 
		...
		\midrule
		\multirow{3}{*}{$\text{ET}_1$} 
		& n=100 & 0.07 & 0.11 & 0.17 & 0.23 & 0.32 & 0.41 & 0.49 & 0.58 & 0.65 \\ 
		& n=400 & 0.06 & 0.1 & 0.18 & 0.27 & 0.4 & 0.51 & 0.63 & 0.73 & 0.82 \\ 
		& n=900 & 0.07 & 0.1 & 0.18 & 0.28 & \textbf{0.42} & \textbf{0.56} & \textbf{0.69} & \textbf{0.8} & \textbf{0.88} \\ 
		\addlinespace
		\addlinespace
		\multirow{3}{*}{$\text{ET}_2$} 
		& n=100 & \textbf{0.32} & \textbf{0.31} & \textbf{0.32} & \textbf{0.34} & 0.36 & 0.39 & 0.42 & 0.47 & 0.51 \\ 
		& n=400 & 0.13 & 0.14 & 0.15 & 0.16 & 0.17 & 0.19 & 0.22 & 0.25 & 0.28 \\ 
		& n=900 & 0.09 & 0.1 & 0.1 & 0.09 & 0.1 & 0.13 & 0.13 & 0.16 & 0.19 \\ 
		\bottomrule
	\end{tabular}
...
\begin{table}[!h]
	...
	\begin{tabular}{l c c c c c c c c c c} 
		...
		\midrule
		\multirow{3}{*}{$\text{ET}_1$} 
		& n=100 & 0.08 & 0.13 & 0.22 & 0.35 & \textbf{0.53} & 0.69 & \textbf{0.83} & \textbf{0.92} & 0.96 \\ 
		& n=400 & 0.07 & 0.12 & 0.21 & 0.36 & 0.52 & \textbf{0.7} & \textbf{0.83} & \textbf{0.92} & \textbf{0.97} \\ 
		& n=900 & 0.05 & 0.1 & 0.18 & 0.31 & 0.47 & 0.66 & 0.81 & 0.91 & 0.96 \\ 
		\addlinespace
		\addlinespace
		\multirow{3}{*}{$\text{ET}_2$} 
		& n=100 & 0.19 & 0.2 & 0.22 & 0.26 & 0.32 & 0.4 & 0.5 & 0.6 & 0.73 \\ 
		& n=400 & \textbf{0.27} & \textbf{0.31} & \textbf{0.35} & \textbf{0.41} & 0.48 & 0.58 & 0.67 & 0.77 & 0.85 \\ 
		& n=900 & 0.11 & 0.12 & 0.13 & 0.14 & 0.17 & 0.22 & 0.29 & 0.34 & 0.46 \\ 
		\bottomrule
	\end{tabular}
